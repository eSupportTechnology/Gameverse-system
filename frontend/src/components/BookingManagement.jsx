...
const BookingManagement = () => {
  ...
  return (
    <Box sx={{ p: 2, bgcolor: "1E1E1E", color: "#fff", minHeight: "100vh", overflowX: "hidden", }}>
          ...
          <ToggleButtonGroup
            ...
            sx={{
              ...
              "& .MuiToggleButton-root": {
                ...
                "&.Mui-selected:hover": {
                  bgcolor: "#00d1eb", // hover effect when selected
                },
                "&:hover": {
                  bgcolor: "#374151", // hover effect when not selected
                },
              },
            }}
          >
      ...
      {/* Toolbar */}
      <Box display="flex" justifyContent="space-between" px={1.5} py={1.5} borderRadius='10px' bgcolor='#0E111B' alignItems="center" mb={2}>
        {/* <DatePicker
          label="Select Date"
          value={date}
