        ...
        <DialogContent dividers sx={{ py: 0, pb: 2 }}>
          ...
          <Box mb={2}>
            ...
            <Box display="flex" gap={2}>
              ...
              >
                <Typography sx={{ color: isTeamGame === true ? "#ffffff" : "rgba(255,255,255,0.6)", fontSize: 14 }}>
                  Yes
                </Typography>
                <Box sx={{
              ...
              >
                <Typography sx={{ color: isTeamGame === false ? "#ffffff" : "rgba(255,255,255,0.6)", fontSize: 14 }}>
                  No
                </Typography>
                <Box sx={{
                  width: 22, height: 22, borderRadius: "50%",
