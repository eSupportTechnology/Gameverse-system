...
import AdminBookinFrom from './AdminBookinFrom.jsx';
import AdminBookingsGrid from './AdminBookingsGrid.jsx';
...
// Sample stations and bookings
  const stations = [
    { name: "PSS Station 1", subname: 'PSS Station 1', value:"station1", rate: "$12.5/hr" },
    { name: "PSS Station 2", subname: 'PSS Station 2',value:"station2", rate: "$12.5/hr" },
    { name: "PSS Station 3", subname: 'PSS Station 3',value:"station3", rate: "$12.5/hr" },
    { name: "PSS Station 4", subname: 'PSS Station 4',value:"station4", rate: "$12.5/hr" },
    { name: "8 Ball Pool(Suprime)", subname: 'Pool1',value:"station5", rate: "$12.5/hr" },
    { name: "8 Ball Pool(Premium)", subname: 'Pool2',value:"station6", rate: "$12.5/hr" },
  ];
...
// );
const [date, setDate] = React.useState(
  new Date().toISOString().split("T")[0] // gives "2025-10-03"
);
  ...
  return (
    <Box sx={{ p: 2, bgcolor: "1E1E1E", color: "#fff", minHeight: "100vh", overflowX: "hidden", ml: 0, }}>
      ...
      >
        ...
        >
          ...
          <Box>
            ...
            <AdminBookinFrom open={openDialog} handleClose={() => setOpenDialog(false)} />
          </Box>
        </Box>
      </Box>
                  ...
                  <Box key={i} sx={{ display: "flex", mb: 2 }}>
                    {timeSlots.map((slot) => {
                      ...
                      const booking = bookings.find(
                        (b) => b.station === station.value &&
                          b.start_time.slice(0, 5) === slot &&
                          b.date === date
                      );
                      if (booking) {
      ...
      {view === "grid" &&
        <AdminBookingsGrid selectedDate={date} />
      }
