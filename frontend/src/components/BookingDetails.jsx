        ...
        <DialogContent sx={{ py: 0, pb: 2 }}>
          ...
          >
            ...
            <Box display="flex" flexDirection="column" gap={0.5}>
              ...
              <Typography fontSize={12} color="#9CA3AF">{booking.phone_number}</Typography>
              <Typography fontSize={10} color="#FFFFFF">{booking.email}</Typography>
            </Box>

            {/* RIGHT */}
            <Box textAlign="right">
              <Typography fontSize={12} color="#FFFFFF" mb={1}>Booking #{booking.id}</Typography>
              ...
              <Typography fontSize={16} color="#fff">Loyalty Points</Typography>
            </Box>
          </Box>
          ...
          >
            {/* SESSION */}
            <Box sx={{ flex: 1, bgcolor: "#18212F", p: 2, borderRadius: "12px" }}>
              <Box display="flex" alignItems="center" gap={1} mb={1}>
                <SportsEsportsIcon sx={{ color: "#9CA3AF" }} />
                <Typography fontSize={16} fontWeight={600}>Session Details</Typography>
              </Box>
            ...
            <Box sx={{ flex: 1, bgcolor: "#18212F", p: 2, borderRadius: "12px" }}>
              <Box display="flex" alignItems="center" gap={1} mb={1}>
                ...
                <Typography fontSize={16} fontWeight={600}>Payment Info</Typography>
              </Box>

              <Row label="Method" value={booking.paymentMethod || 'Cash'} />
              <Row label="Online Deposit" value={`LKR ${booking.onlineDeposit || '0'}`} />

              <hr style={{ border: "none", borderTop: "1px solid #374151" }} />

              <Row label="Total Amount" value={`LKR ${booking.amount}`} highlight />
              <Row label="Balance Amount" value={`LKR ${booking.balanceAmount}`} highlight />
            </Box>
          </Box>
          ...
          {booking.status === "inprogress" && (
            <Box sx={{ mt: 2 }}>
              ...
              <Box sx={{ display: "flex", justifyContent: "center" }}>
                ...
                >
                  <img src={arrowicon} alt="" style={{ width: 12, marginRight: 8 }} />
                  End Session
                </Button>
              </Box>
            </Box>
          ...
          {booking.status === "upcoming" && (
            <Box display="flex" gap={2} mt={2}>
              ...
              >
                <img src={editicon} alt="" style={{ width: 14, marginRight: 8 }} />
                Edit
              </Button>
              ...
              >
                <img src={crossicon} alt="" style={{ width: 14, marginRight: 8 }} />
                Cancel
              </Button>
            </Box>
          )}
...
const Row = ({ label, value, highlight }) => (
  <Box display="flex" justifyContent="space-between">
    <Typography fontSize={14} color='#A6AAB0'>{label}:</Typography>
    <Typography
      fontSize={14}
      sx={{
