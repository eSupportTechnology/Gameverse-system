          ...
          >
            {filteredStations.length === 0 && (
              <Box sx={{ gridColumn: "1 / -1", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", py: 10, gap: 2 }}>
                ...
                <Typography sx={{ fontSize: 16, fontWeight: 600, color: "#9CA3AF" }}>No Stations Found</Typography>
                <Typography sx={{ fontSize: 13, color: "#4B5563" }}>No PS5 stations have been added yet</Typography>
              </Box>
            )}
